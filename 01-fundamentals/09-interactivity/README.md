...
<div class="controls-panel">
    ...
    <div class="control-group">
        <label for="ambientStrength">Ambient Light</label>
        <input type="range" id="ambientStrength" min="0" max="1" step="0.05" value="0.3" />
    </div>

    <div class="control-group">
        <label>Material</label>
        <div class="button-group">
            <button id="materialMetal">Metal</button>
            <button id="materialPlastic">Plastic</button>
            <button id="materialWood">Wood</button>
        </div>
    </div>
...
function updateMaterial() {
    ...
    gl.uniform1f(gl.getUniformLocation(program, 'uMetalness'), metalness);
    gl.uniform3fv(gl.getUniformLocation(program, 'uAlbedo'), albedo);
}
...
function updateBackground() {
    switch (settings.background) {
        case 'skybox':
            ...
            break;
        case 'solid':
            // Disable skybox, use solid color
            renderSkybox = false;
            gl.clearColor(0.2, 0.3, 0.4, 1.0);
            break;
        case 'gradient':
            // Disable skybox, use gradient (in fragment shader)
            renderSkybox = false;
            gl.clearColor(0, 0, 0, 0);
...
### Advanced UI Integration: Color Picker

For more complex UI elements, you can use libraries or custom components:
...
Add JavaScript to toggle the UI visibility:
