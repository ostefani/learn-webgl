/**
 * Simplified version of gl-matrix.js for the WebGL demo
 * This includes only the matrix and vector operations we need
 */
...
const mat4 = {
    ...
    lookAt: function (out, eye, center, up) {
        ...
        // Calculate cross product of up and z
        ...
        // Calculate cross product of z and x (gives y)
        let y0 = z1 * x2 - z2 * x1;
        let y1 = z2 * x0 - z0 * x2;
        let y2 = z0 * x1 - z1 * x0;
    ...
    transpose: function (out, a) {
        if (out === a) {
            // If output is same as input, use a temporary variable
            const a01 = a[1],
                a02 = a[2],
                a03 = a[3];
            const a12 = a[6],
